...
model = onnx.load("/home/lli/tools/reluspliter/tests/mnist_fc/onnx/mnist-net_256x6.onnx")
...
input_ranges, spec = read_vnnlib("/home/lli/tools/reluspliter/tests/mnist_fc/vnnlib/prop_2_0.03.vnnlib")[0]
