...
if __name__=="__main__":
    ...
    output_path = STORAGE_ROOT / (benchmark_name+"_2l") / f"{benchmark_name}_idx-{conf['split_idx']}_method-{conf['bounding_method']}_mask-{conf['split_mask']}_mode-{args.mode}_seed-{args.seed}"
